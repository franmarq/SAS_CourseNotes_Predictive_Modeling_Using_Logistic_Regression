/* Code for the Practices in Lessons 1 though 4 of the SAS
...
Lessons 1, 2, 3 and 4. The title of each practice and
...
/* ===================================================== */
/* Lesson 4, Practice 1: l4s1.sas
   Practice: Assessing Model Performance 
   [m644_2_p; derived from pmlr04s01.sas]                */
/* ===================================================== */
